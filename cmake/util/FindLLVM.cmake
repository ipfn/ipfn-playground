...
# - IPFN_LLVM_VERSION
#
# Source: https://github.com/dmlc/tvm/blob/master/cmake/util/FindLLVM.cmake
#
...
macro(find_llvm use_llvm)
  ...
  if(LLVM_CONFIG STREQUAL "ON")
    ...
    set(IPFN_LLVM_VERSION ${LLVM_VERSION_MAJOR}${LLVM_VERSION_MINOR})
  ...
  elseif(NOT LLVM_CONFIG STREQUAL "OFF")
    ...
    execute_process(COMMAND ${LLVM_CONFIG} --version
      COMMAND cut -b 1,3
      OUTPUT_VARIABLE IPFN_LLVM_VERSION)
    # definitions
    ...
    string(STRIP ${IPFN_LLVM_VERSION} IPFN_LLVM_VERSION)
  endif()
  if(NOT LLVM_CONFIG STREQUAL "OFF")
    ...
    message(STATUS "Found IPFN_LLVM_VERSION=" ${IPFN_LLVM_VERSION})
  endif()
endmacro(find_llvm)